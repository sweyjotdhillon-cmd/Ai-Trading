...
import { calculateVolatilityRegime, calculateZScoreSignificance, calculateRQA } from "./mathEngine";
...
export function evaluateSignal(ohlcSeries: NumericOHLC[], techniquesList: string[] = [], expectedMove: number = 0, horizonCtx: HorizonContext = { timeframe: '5m', duration: '15m', expectedCandles: 3, horizonClass: 'SCALP' }): DecisionResult {

...
describe('Temporal Filter Integration', () => {
  ...
  it('preserves determinism: identical inputs yield identical outputs', () => {
    const res1 = applyTemporalFilter('LONG', 80, 70, true);
    resetTemporalFilter();
    const res2 = applyTemporalFilter('LONG', 80, 70, true);
  ...
  it('never forces a trade: NO_TRADE raw always yields NO_TRADE', () => {
    // Initial high confidence LONG
    applyTemporalFilter('LONG', 90, 80, true);

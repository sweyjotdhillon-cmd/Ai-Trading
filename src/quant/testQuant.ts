...
const sysUp = evaluateSignal(uptrend, { percent: () => -1000 } as any, { tfMinutes: 30, durationMinutes: 5, H: 5/30, horizonClass: 'INTRA_CANDLE' }, 'REAL_PRICE', ["__TEST_BYPASS__"]);
...
const sysDown = evaluateSignal(downtrend, { percent: () => 1000 } as any, { tfMinutes: 30, durationMinutes: 5, H: 5/30, horizonClass: 'INTRA_CANDLE' }, 'REAL_PRICE', ["__TEST_BYPASS__"]);
...
const sysNoise = evaluateSignal(noise, null, { tfMinutes: 30, durationMinutes: 5, H: 5/30, horizonClass: 'INTRA_CANDLE' }, 'REAL_PRICE', ["__TEST_BYPASS__"]);
